...
onMounted(() => {
  ...
  if (welcomeTexts?.length > 0) {
    ...
    terminal.writeTextOutput(
      `Welcome to FurinaIndex, coolest browser index for geeks!` +
        `<a href="//github.com/Furinaluna/zcwindex" target='_blank'> GitHub Open Source</a>`
    );
    terminal.writeTextOutput(
      `Author <a href="//github.com/Furinaluna" target="_blank">Furinaluna</a>` +
