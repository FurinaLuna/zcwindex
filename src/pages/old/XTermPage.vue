...
const initXTerm = () => {
  ...
  term.writeln("Welcome to FurinaIndex，coolest browser index for geeks!,background will be random,input bg to change the background.");
  term.writeln("Author FurinaLuna: https://github.com/FurinaLuna");
  term.prompt();
